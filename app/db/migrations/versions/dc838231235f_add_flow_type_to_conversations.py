...
def upgrade() -> None:
    ...
    op.add_column(
        'conversations',
        sa.Column('flow_metadata', JSON, nullable=True, server_default='{}')
    )
    ...
    op.add_column(
        'messages',
        sa.Column('message_metadata', JSON, nullable=True, server_default='{}')
    )
    ...
    op.create_index(
        'ix_conversations_tenant_flow',
        'conversations',
        ['tenant_id', 'flow_type', 'updated_at']
    )

    op.create_index(
        'ix_messages_tenant_flow',
        'messages',
        ['tenant_id', 'flow_type', 'created_at']
    )

    op.create_index(
        'ix_messages_conversation_flow',
        'messages',
        ['conversation_id', 'flow_type', 'created_at']
    )
